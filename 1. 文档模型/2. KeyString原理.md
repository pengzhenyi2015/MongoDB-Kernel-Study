...
表和索引中的数据存储方式如下：    
|表数据|表 Key(RecordId) ->Value(BSON)|索引1 (a_1_b_1)|索引1 Key(KeyString with __RecordId__)->Value (typebits if exist)|索引2 (a_1)|索引2 Key(KeyString with __RecordId__)->Value (typebits if exist)|  
|:--|:--|:--|:--|:--|:--|
|{ "_id" : ObjectId("64a3a1f9cafa66ad966b193a"), <br>"a" : NumberInt(1), <br>"b" : "1" }|1->0x26000000075F69640064A3A1F9CAFA66AD966B193A1061000100000002620002000000310000|{"":1,"":"1"}->RecordId(1)|0x2B023C310004**0008**->0x00|{"":1}-> RecordId(1)|0x2B0204**0008**->0x00|
|{ "_id" : ObjectId("64a3a1fdcafa66ad966b193b"), "a" : NumberInt(2), <br>"b" : "2" }|2->0x26000000075F69640064A3A1FDCAFA66AD966B193B1061000200000002620002000000320000|{"":2,"":"2"}->RecordId(2)|0x2B043C320004**0010**->0x00|{"":2}-> RecordId(2)|0x2B0404**0010**->0x00|
|{ "_id" : ObjectId("64a3a202cafa66ad966b193c"), "a" : NumberInt(3),<br> "b" : "3" }|3->0x26000000075F69640064A3A202CAFA66AD966B193C1061000300000002620002000000330000|{"":3,"":"3"}->RecordId(3)|0x2B063C330004**0018**->0x00|{"":3}-> RecordId(3)|0x2B0604**0018**->0x00|
