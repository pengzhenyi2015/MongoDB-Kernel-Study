...
### 3.5.1 Raft 原理
#### Snapshot
Raft 论文的 log compaction 章节说明了 raft 的机制：各个节点在特定条件下（时间周期和 log 大小），会将状态机中的已提交的数据（commit point）做 snapshot 到磁盘，然后将 commit point 之前的日志清除。    
...
<p align="center">
  <img src="https://github.com/pengzhenyi2015/MongoDB-Kernel-Study/assets/16788801/d389b0ec-4198-4b7c-92cf-1bb90e639754" width=500>
</p>
