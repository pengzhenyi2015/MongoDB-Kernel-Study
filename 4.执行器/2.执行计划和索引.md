...
<p align="center">
<img width="1212" height="776" alt="image" src="https://github.com/user-attachments/assets/5ffb6ae3-3d6e-4e22-8c91-95c5fb9adb00" />
</p>
...
<p align="center">
<img width="1412" height="945" alt="image" src="https://github.com/user-attachments/assets/d422eda3-6750-4c44-88c8-e304a168c7d1" />
</p>
...
1. 如何确定起始步长？        
   ...
   <p align="center">
	<img width="995" height="938" alt="image" src="https://github.com/user-attachments/assets/ae507dc1-9b5c-4142-ae52-5fcd1c127d6b" />
   </p>
...
3. 如何避免重复扫描？    
   ...
   <p align="center">
   <img width="586" height="579" alt="image" src="https://github.com/user-attachments/assets/e32d19b8-45a5-42b7-a57d-327383cce433" />
   </p>
...
7. S2CellId 非常适合[作为 btree 索引的 key](https://github.com/mongodb/mongo/blob/r4.2.25/src/mongo/db/index/s2_common.cpp#L74). 而且和 GeoHash 索引一样， level 每增加 1， 索引的范围就会缩小 4 倍。     
   <TODO  2 张图>
